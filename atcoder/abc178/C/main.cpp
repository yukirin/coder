...
int main(int argc, char* argv[]) {
  ...
  ll ans = modpow(10, N, MOD), zero_or_nine = modpow(9, N, MOD), one_eight = modpow(8, N, MOD);
  zero_or_nine = mod(zero_or_nine - one_eight, MOD);

  ans = mod(ans - one_eight, MOD);
  ans = mod(ans - zero_or_nine * 2, MOD);
  put(ans);
